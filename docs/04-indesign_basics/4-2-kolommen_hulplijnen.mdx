...
Een andere handige aanpak, om je hulplijnen overal toe te passen, is de hulplijnen in te stellen op je **stramien** (Zie [5.1 Stramienen](docs/05-indesign_intermediate/5-1-stramienen.mdx)).
